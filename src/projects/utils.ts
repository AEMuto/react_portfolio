...
export type Project = ProjectMetadata & { content: MDXContent };
...
export const loadProjectThumbnail = (projectName: string) => {
  const thumbnails = import.meta.glob(
    "/src/projects/*/assets/images/thumbnail.{jpg,jpeg,png,webp}",
    {
      eager: true,
      import: "default",
    }
  ...
  const thumbnailEntry = Object.entries(thumbnails).find(([path]) =>
