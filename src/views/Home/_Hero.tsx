  ...
  return (
    <SlideContainer id="header" isHeader={true}>
      <SlideColumn>
        ...
        <Typography size="lg">
          Je suis quelqu'un d'enthousiaste qui aime résoudre des problèmes grâce au code. Ma plus
          grande source de motivation est la construction de solutions performantes, élégantes et
          facile d'utilisation pour tout le monde.
        </Typography>
        <Typography size="lg">
          <b>Spécialisé dans le développement web</b>, les dernières technologies que j'ai utilisées
        ...
        <CTAContainer>
          ...
          <a
            ...
            title="Pour consulter mon CV"
            target="_blank"
            rel="noreferrer">
            <Button option="alternate">Consulter mon CV</Button>
          </a>
        </CTAContainer>
      </SlideColumn>
      <StyledSlideColumn>
